...
export default function HomePage() {
  ...
  const TimerView = (
    <div className="flex flex-col items-center gap-6 w-full max-w-md mx-auto">
         <Card className="w-full shadow-lg bg-card/70 backdrop-blur-sm">
            <CardHeader>
        ...
        <AnimatePresence>
            {pomodoro.activeSessions.map((session, index) => (
                <motion.div
                    ...
                    className="w-full"
                >
                    <Card className="w-full shadow-lg relative overflow-hidden bg-card/70 backdrop-blur-sm">
  ...
  const InsightsView = (
      <Card className="w-full max-w-2xl mx-auto shadow-lg bg-card/70 backdrop-blur-sm">
          <CardHeader>
